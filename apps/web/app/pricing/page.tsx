...
const Pricing = () => {
  return (
    <div className="relative w-full">
      <main className='max-w-7xl mx-auto relative flex flex-1 flex-col items-center justify-center font-sans gap-6 overflow-x-hidden pt-24 pb-16 md:pt-32 md:pb-24 lg:pt-44'>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 md:grid-cols-3">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative flex flex-col rounded-3xl border-2 p-8 transition-all hover:scale-105 ${plan.featured
            ...
            >
              ...
              <Button
                className={`w-full h-12 text-base font-bold transition-all hover:opacity-90 ${plan.featured ? "bg-primary text-primary-foreground" : ""
                  }`}
