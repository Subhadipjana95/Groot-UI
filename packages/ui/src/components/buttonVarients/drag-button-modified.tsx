...
const DEFAULT_COLORS = {
    light: "var(--color-rose-500)",
    dark: "var(--color-rose-800)"
} as const;
    ...
    (
        ...
        return (
            <Button
                ...
                variant={variant}
                className={cn(
                    "relative h-12 min-w-50 cursor-grab overflow-hidden rounded-xl p-1 py-1.5 text-sm font-medium transition-all duration-300 flex items-center select-none",
            ...
            >
                ...
                <motion.span
                    ...
                    className="relative z-10 mx-auto transition-all duration-500 text-shadow-black/10 text-shadow-lg pointer-events-none pl-6"
                >
                    {children}
                </motion.span>
                ...
                >
                    <StyledButton variant="rose" className="pointer-events-none absolute left-1/2 top-0 z-20 w-[90%] h-full -translate-x-1/2">
                        <ArrowRight size={20} className="text-foreground drop-shadow-sm relative z-30" />
                    </StyledButton>
                </motion.div>
